...
-- Blocked function names: (none)
-- JSON syntax allowed only for configured JSON schemas: JSON_VIEW
-- Helper schema mappings: JSON_VIEW->JSON_VIEW_INTERNAL
-- Helper rewrite mode: wrapper semantic helpers
-- Path identifier rewrite: enabled (joins)

CREATE SCHEMA IF NOT EXISTS JVS_WRAP_PP;

CREATE OR REPLACE LUA PREPROCESSOR SCRIPT JVS_WRAP_PP.JSON_WRAPPER_PREPROCESSOR AS
    local HELPER_KIND_BY_NAME = {
        ['JNULL'] = 'explicit_null',
        ['JSON_AS_BOOLEAN'] = 'variant_as_boolean',
        ['JSON_AS_DECIMAL'] = 'variant_as_decimal',
        ['JSON_AS_VARCHAR'] = 'variant_as_varchar',
        ['JSON_IS_EXPLICIT_NULL'] = 'explicit_null',
        ['JSON_TYPEOF'] = 'variant_typeof',
    }
    local BLOCKED_FUNCTIONS = {

    }
    local BLOCKED_FUNCTION_MESSAGE = 'This helper is not available on the wrapper surface yet.'
    local ALLOWED_JSON_SCHEMAS = {
        JSON_VIEW = true,
    }
    local ALLOWED_JSON_SCHEMA_LIST = 'JSON_VIEW'
    local EXAMPLE_ALLOWED_SCHEMA = 'JSON_VIEW'
    local HELPER_SCHEMA_BY_ALLOWED_SCHEMA = {
        JSON_VIEW = 'JSON_VIEW_INTERNAL',
    }
    local GROUP_CONFIG_BY_SCHEMA_AND_TABLE = {
        ['JSON_VIEW'] = {
            ['DEEPDOC'] = {
                ['CHAIN|OBJECT'] = {
                    ['variantColumns'] = {
        ...
        ['JSON_VIEW_INTERNAL'] = {
            ...
            ['DEEPDOC_CHAIN_NEXT_NEXT_NEXT_NEXT'] = {
                ['NEXT|OBJECT'] = {
                    ['variantColumns'] = {
                        ['OBJECT'] = 'next|object',
                    },
            ...
            ['DEEPDOC_CHAIN_NEXT_NEXT_NEXT_NEXT_NEXT'] = {
                ['NEXT|OBJECT'] = {
                    ['variantColumns'] = {
                        ['OBJECT'] = 'next|object',
                    },
            ...
            ['DEEPDOC_CHAIN_NEXT_NEXT_NEXT_NEXT_NEXT_NEXT'] = {
                ['NEXT|OBJECT'] = {
                    ['variantColumns'] = {
                        ['OBJECT'] = 'next|object',
                    },
            ...
            ['DEEPDOC_CHAIN_NEXT_NEXT_NEXT_NEXT_NEXT_NEXT_NEXT'] = {
                ...
                ['LEAF_NOTE'] = {
                    ['nullMaskName'] = 'leaf_note|n',
                    ['variantColumns'] = {
                        ['STRING'] = 'leaf_note',
                    },
                },
                ['READING'] = {
                    ['nullMaskName'] = 'reading|n',
                    ['variantColumns'] = {
                        ['NUMBER'] = 'reading',
