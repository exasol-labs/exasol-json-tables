...
-- JSON syntax allowed only for configured JSON schemas: JSON_VS
-- Helper schema mappings: (none)
-- Helper rewrite mode: virtual-schema CASE marker
...
CREATE OR REPLACE LUA PREPROCESSOR SCRIPT JVS_PP.JSON_NULL_PREPROCESSOR AS
    ...
    local BLOCKED_FUNCTION_MESSAGE = 'This helper is not available in this build.'
    local ALLOWED_JSON_SCHEMAS = {
        JSON_VS = true,
    }
    local ALLOWED_JSON_SCHEMA_LIST = 'JSON_VS'
    local EXAMPLE_ALLOWED_SCHEMA = 'JSON_VS'
