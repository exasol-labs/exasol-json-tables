...
MODULES = [
    ...
    "adapter.JsonVirtualSchemaAdapter",
]


def module_path(module_name: str) -> Path:
    if "." in module_name:
        return SRC / (module_name.replace(".", "/") + ".lua")
    return SRC / f"{module_name}.lua"
...
def main() -> None:
    ...
    entry_source = (SRC / "entry.lua").read_text()
