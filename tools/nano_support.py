...
def _base_fixture_statements() -> list[str]:
    return [
        ...
        'CREATE OR REPLACE TABLE "SAMPLE_items_arr_nested" ("_id" DECIMAL(18,0) NOT NULL, "note" VARCHAR(100), "score" DECIMAL(18,0), "active" BOOLEAN, "items|array" DECIMAL(18,0))',
        ...
        'INSERT INTO "SAMPLE_items_arr_nested" VALUES (7001, \'nested-a\', 11, TRUE, 2)',
        'INSERT INTO "SAMPLE_items_arr_nested" VALUES (7002, \'nested-b\', 12, FALSE, 1)',
